...
const timelineEvents = [
  {
    ...
    icon: "�",
    details:
      "Ngày 08/02/2025 - Em là con bé chiều hôm qua mới qua văn phòng chào mn á. Một cuộc gặp gỡ định mệnh đã thay đổi cuộc đời cả hai.",
  },
  {
    id: 2,
    date: "2025-02-09",
    ...
    description:
      '"Anh ơi, e là con bé chiều hôm qua mới qua văn phòng chào mn á. E hỏi anh cái này xíu"',
    type: "milestones",
    icon: "💬",
    details:
      "Tin nhắn đầu tiên của em đã mở ra cánh cửa cho tình yêu của chúng ta. Đơn giản nhưng đầy ý nghĩa.",
  },
  {
    id: 3,
    date: "2025-02-28",
    title: "Đổi màu Mess",
    description:
      "Ngày chúng ta đổi màu tin nhắn - dấu hiệu đầu tiên của tình cảm đặc biệt",
    type: "special",
    icon: "🎨",
    details:
      "Một cử chỉ nhỏ nhưng có ý nghĩa lớn. Cả hai đều cảm nhận được sự khác biệt trong mối quan hệ.",
  },
  {
    id: 4,
    date: "2025-03-06",
    ...
    icon: "💝",
    details:
      "Ngày 06/03/2025 - Buổi hẹn đầu tiên đầy ắp những cảm xúc mới mẻ và hồi hộp.",
  },
  {
    id: 5,
    date: "2025-03-12",
    ...
    icon: "�",
    details:
      "Ngày 12/03/2025 - Chúng ta ngày càng hiểu nhau hơn qua những cuộc trò chuyện sâu sắc.",
  },
  {
    id: 6,
    date: "2025-03-15",
    ...
    icon: "💖",
    details:
      "Ngày 15/03/2025 - Tình cảm giữa hai ta ngày càng sâu đậm và rõ ràng hơn.",
  },
  {
    id: 7,
    date: "2025-03-22",
    ...
    icon: "🌹",
    details:
      "Ngày 22/03/2025 - Buổi hẹn cuối cùng trước khi anh chính thức tỏ tình với em.",
  },
  {
    id: 8,
    date: "2025-03-23",
    ...
    icon: "�",
    details:
      'Ngày 23/03/2025 - "em đồng ý làm người yêu anh nha" - Câu trả lời làm anh hạnh phúc nhất đời. Từ đây, chúng ta chính thức bắt đầu hành trình tình yêu.',
  },
  {
    id: 9,
    date: "2025-04-24",
    ...
    icon: "🤭",
    details:
      'Ngày 24/04/2025 - "bị cáo đề nghị thêm một ngày 24 vào lịch là ngày chuộc lỗi nữa :)))" - Một ngày đặc biệt chỉ có của riêng chúng ta.',
  },
  {
    id: 10,
    date: "2025-10-08",
    ...
    icon: "🎂",
    details:
      "Ngày 08/10/2025 - Sinh nhật đầu tiên của em khi chúng ta đã là người yêu. Anh sẽ chuẩn bị những điều đặc biệt nhát cho em.",
  },
  {
    id: 11,
    date: "2025-10-28",
    ...
    icon: "🎂",
    details:
      "Ngày 28/10/2025 - Sinh nhật đầu tiên của anh khi chúng ta đã yêu nhau. Em sẽ có những món quà bất ngờ cho anh.",
  },
];
  ...
  modalBody.innerHTML = `
        <div class="event-detail">
            ...
            <div class="detail-type">
                <span class="type-badge ${event.type}">${getTypeLabel(
    event.type
  )}</span>
            </div>
        </div>
...
function createMilestoneElement(milestone) {
  ...
  milestoneDiv.innerHTML = `
        ...
        ${
          isUpcoming
            ? `<div class="milestone-countdown">${daysLeft} ngày nữa</div>`
            : ""
        }
...
function updateStats() {
  ...
  document.getElementById("placesVisited").textContent = timelineEvents.filter(
    (e) => e.type === "trips"
  ).length;
  document.getElementById("celebrations").textContent = timelineEvents.filter(
    (e) => e.type === "special"
  ).length;
}
